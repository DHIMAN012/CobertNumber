...
public class Convert extends JFrame {
    ...
    ImageIcon background=new ImageIcon("icon.jpg");
    
    Image img=background.getImage();
    Image temp_image=img.getScaledInstance(900, 600, Image.SCALE_SMOOTH);
    // background=new ImageIcon(temp_image);
    ImageIcon background_image=new ImageIcon(temp_image);
...
//  TO :
        ...
        setSize(850,600);
        getContentPane().setBackground(new Color(181,45,67));
